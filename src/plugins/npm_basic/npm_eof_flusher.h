...
#ifndef _FLOWSQL_PLUGINS_NPM_BASIC_NPM_EOF_FLUSHER_H_
#define _FLOWSQL_PLUGINS_NPM_BASIC_NPM_EOF_FLUSHER_H_
...
class NpmEofFlusher final {
 public:
    ...
    NpmEofFlushStatus Flush(int64_t observed_at,
                            NpmSessionTable& sessions,
                            const std::vector<INpmAnalysisModule*>& modules,
                            NpmBasicResultCollector& collector,
...
#endif  // _FLOWSQL_PLUGINS_NPM_BASIC_NPM_EOF_FLUSHER_H_
