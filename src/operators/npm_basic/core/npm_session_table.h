...
class NpmSessionTable {
 public:
    ...
    NpmSessionTableError SampleProtocol(const NpmSessionKey& key, uint64_t session_id, const NpmPacketView& packet,
                                        packet::IPacketProtocolIdentifier& identifier, NpmSessionView* output);
