...
class NpmTcpPerformanceTracker final {
 public:
    explicit NpmTcpPerformanceTracker(std::shared_ptr<INpmTaskBudget> budget,
                                      uint32_t max_ranges_per_direction = 1024);
    ...
    NpmTcpPerformanceError Snapshot(const NpmSessionView& session,
